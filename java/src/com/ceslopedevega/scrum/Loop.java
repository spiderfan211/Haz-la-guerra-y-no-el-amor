...
public class Loop {
	...
	public static void play() {
        ...
        map.add(new Room("room0", 0,  "Te encuentras en la calle, ves una casa blanca al este y una dorada al sur", Character.Direction.NOEXIT, 2, Character.Direction.NOEXIT, 1));
        map.add(new Room("room1", 1, "Te encuentras en la casa blanca. Al sur tienes la salida y no se ve ninguna puerta más", Character.Direction.NOEXIT, Character.Direction.NOEXIT, 0, Character.Direction.NOEXIT));
        map.add(new Room("room2", 2, "Estás en la casa dorada. Ves la vuelta a la calle al norte, una habitación de trolls al este y una cueva oscura al sur", 0, 4, Character.Direction.NOEXIT, 3));
        map.add(new Room("room3", 3, "Estás en la habitación de los trolls. Al oeste ves la tenue luz de la habitación dorada. No hay más salidas", Character.Direction.NOEXIT, 5, 2, Character.Direction.NOEXIT));
        map.add(new Room("room4", 4, "Has llegado a la cueva oscura. No ves nada, pero sabes que has venido desde el norte, e intuyes que hay una puerta al este", 2, Character.Direction.NOEXIT, Character.Direction.NOEXIT, 5));
        map.add(new Room("room5", 5, "Has llegado a la sala final. Enhorabuena.", 3, Character.Direction.NOEXIT, 4, Character.Direction.NOEXIT));
